...
<body class="body">
    <div class="flex-container">
        ...
        <div class="knowledge">
            ...
            <br>
            <P7 id="replace">Ваша конфигурация, используемая в браузере уже на сервере(Вообще такие моменты стоит реализовывать через базы данных) <?php $text = file_get_contents("configuration.txt"); echo $text; ?></p7>
            <br><br><br>
